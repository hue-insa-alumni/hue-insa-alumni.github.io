...
Nội dung wiki nằm trong thư mục [`wiki/`](wiki/). Mỗi trang là một file Markdown (`.md`).
...
wiki/
├── index.md                        # Trang chủ
├── gioi-thieu-chuong-trinh.md      # Trang tổng quan của mỗi mục
├── gioi-thieu-chuong-trinh/        # Thư mục chứa các trang con
│   ├── nguon-goc.md
│   └── chuong-trinh-hoc-viet-nam-va-phap.md
└── ...
```
...
Xem hướng dẫn đầy đủ tại trang [Hướng dẫn sử dụng](wiki/huong-dan.md) trong wiki.
